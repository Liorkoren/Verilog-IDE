/* Generated By:JavaCC: Do not edit this line. JccVerilogLexerTokenManager.java */
package com.koltem.jccveriloglexer;

/** Token Manager. */
public class JccVerilogLexerTokenManager implements JccVerilogLexerConstants
{
...
protected JccVerilogLexerCharStream input_stream;
...
/** Constructor. */
public JccVerilogLexerTokenManager(JccVerilogLexerCharStream stream){
   if (JccVerilogLexerCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}

/** Constructor. */
public JccVerilogLexerTokenManager(JccVerilogLexerCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}

/** Reinitialise parser. */
public void ReInit(JccVerilogLexerCharStream stream)
{
...
/** Reinitialise parser. */
public void ReInit(JccVerilogLexerCharStream stream, int lexState)
{
   ReInit(stream);
   SwitchTo(lexState);
}
