...
public class VerilogProject implements Project {
    ...
    VerilogProject(FileObject dir, ProjectState state) {
        this.projectDir = dir;
        this.state = state;
    }
    ...
    public static Icon getIcon() {
        return new ImageIcon(ImageUtilities.loadImage(Info.CUSTOMER_ICON));
    ...
    private final class Info implements ProjectInformation {
        ...
        @StaticResource()
        public static final String CUSTOMER_ICON = "com/koltem/verilogprojecttype/verilogproject.png";
        ...
        public Project getProject() {
            return VerilogProject.this;
        }

    }

    class VerilogProjectLogicalView implements LogicalViewProvider {
        ...
        private final class ProjectNode extends FilterNode {
            ...
            public ProjectNode(Node node, VerilogProject project) throws DataObjectNotFoundException {
                super(node, 
