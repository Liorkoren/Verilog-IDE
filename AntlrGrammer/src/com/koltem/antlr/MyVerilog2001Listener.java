...
import com.koltem.antlr.grammer.verilog.Verilog2001Listener;
 ...
 * @author Koren
 */
public class MyVerilog2001Listener implements Verilog2001Listener {
    ...
    MyVerilog2001Listener(MainJFrame jFrame) {
        this.jFrame = jFrame;
    }
    ...
    public void enterModule_declaration(Verilog2001Parser.Module_declarationContext ctx) {
        jFrame.setModuleProperties(ctx);
    }
}
